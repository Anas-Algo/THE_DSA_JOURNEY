...
> My self-learning notes for understanding Methods in Java.
...
Without methods, a large program can become repetitive and difficult to manage.

Suppose I need to calculate the square of a number multiple times.
