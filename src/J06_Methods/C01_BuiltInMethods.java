...
public class C01_BuiltInMethods {
    public static void main(String[] args) {
        ...
        // Floor
        System.out.println("Math.floor(6.8) = " + Math.floor(6.8)); // Ans: 6.0

        // Ceiling
        System.out.println("Math.ceil(6.2) = " + Math.ceil(6.2)); // Ans: 7.0
        ...
        // Maximum
        System.out.println("Math.max(25, 40) = " + Math.max(25, 40));

        // Minimum
        System.out.println("Math.min(25, 40) = " + Math.min(25, 40));
